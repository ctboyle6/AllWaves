...
const doubleSliderAction = () => {
  ...
  const sliderSwellHgtElement = document.getElementById('slider-swell-hgt');

  if (sliderSwellHgtElement) {
    const sliderSwellHgt = new DoubleSlider(sliderSwellHgtElement);
